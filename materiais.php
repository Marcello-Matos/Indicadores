...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'logistica'
        $where_conditions = ["Departamento = 'logistica'"]; // ALTERADO: 'PCP' para 'logistica'
        $query_params = [];
...
<head>
    ...
    <title>Logística - EMBAQUIM</title> <!-- ALTERADO: Título para Logística -->
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-truck"></i> <!-- ALTERADO: Ícone para Logística -->
                    </div>
                    <div class="logo-text">
                        <h1>Logística - EMBAQUIM</h1> <!-- ALTERADO: Título para Logística -->
                        <p>Sistema de Gestão de Indicadores de Logística</p> <!-- ALTERADO: Descrição para Logística -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores Logística</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores de Logística</p> <!-- ALTERADO: Descrição para Logística -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Logística da empresa.</p> <!-- ALTERADO: Descrição para Logística -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de Logística</h3> <!-- ALTERADO: Título da tabela -->
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de Logística com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
            ...
            const config = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribuição de Indicadores Logística',
                            color: '#f8fafc',
                            font: {
                                size: 16,
                                weight: 'bold'
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_logistica_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Logística - EMBAQUIM</title>
                    <style>
