...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'Vendas'
        $where_conditions = ["Departamento = 'Vendas'"]; // ALTERADO: 'Operações' para 'Vendas'
        $query_params = [];
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-shopping-cart"></i> <!-- ALTERADO: Ícone para Vendas -->
                    </div>
                    <div class="logo-text">
                        <h1>Vendas - EMBAQUIM</h1> <!-- ALTERADO: Título para Vendas -->
                        <p>Sistema de Gestão de Indicadores de Vendas</p> <!-- ALTERADO: Descrição para Vendas -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores de Vendas</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores de Vendas</p> <!-- ALTERADO: Descrição para Vendas -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Vendas da empresa.</p> <!-- ALTERADO: Descrição para Vendas -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de Vendas</h3> <!-- ALTERADO: Título da tabela -->
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de Vendas com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_vendas_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Vendas - EMBAQUIM</title>
                    <style>
