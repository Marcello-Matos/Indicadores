...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - DEPARTAMENTO 'Desenvolvimento'
        $where_conditions = ["Departamento = 'Desenvolvimento'"];
        $query_params = [];
...
<head>
    ...
    <title>Desenvolvimento - EMBAQUIM</title>
...
<body>
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    ...
                    <div class="logo-text">
                        <h1>Desenvolvimento - EMBAQUIM</h1>
                        <p>Sistema de Gestão de Indicadores de Desenvolvimento</p>
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores de Desenvolvimento</h3>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">💻 Sistema de Indicadores de Desenvolvimento</p>
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Desenvolvimento da empresa.</p>
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de Desenvolvimento</h3>
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de Desenvolvimento com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_desenvolvimento_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Desenvolvimento - EMBAQUIM</title>
                    <style>
