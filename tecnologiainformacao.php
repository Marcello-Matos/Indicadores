...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'TI'
        $where_conditions = ["Departamento = 'TI'"]; // ALTERADO: 'Vendas' para 'TI'
        $query_params = [];
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-laptop-code"></i> <!-- ALTERADO: Ícone para TI -->
                    </div>
                    <div class="logo-text">
                        <h1>TI - EMBAQUIM</h1> <!-- ALTERADO: Título para TI -->
                        <p>Sistema de Gestão de Indicadores de Tecnologia da Informação</p> <!-- ALTERADO: Descrição para TI -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores de TI</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores de TI</p> <!-- ALTERADO: Descrição para TI -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Tecnologia da Informação da empresa.</p> <!-- ALTERADO: Descrição para TI -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de TI</h3> <!-- ALTERADO: Título da tabela -->
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de TI com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function criarGraficoIndicadores(tipo = 'pie') {
            ...
            const configBase = {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Distribuição de Indicadores de TI',
                        color: '#f8fafc',
                        font: {
                            size: 16,
                            weight: 'bold',
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_ti_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores TI - EMBAQUIM</title>
                    <style>
