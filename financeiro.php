...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'Financeiro'
        $where_conditions = ["Departamento = 'Financeiro'"]; // ALTERADO: 'logistica' para 'Financeiro'
        $query_params = [];
...
<head>
    ...
    <title>Financeiro - EMBAQUIM</title> <!-- ALTERADO: Título para Financeiro -->
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-dollar-sign"></i> <!-- ALTERADO: Ícone para Financeiro -->
                    </div>
                    <div class="logo-text">
                        <h1>Financeiro - EMBAQUIM</h1> <!-- ALTERADO: Título para Financeiro -->
                        <p>Sistema de Gestão de Indicadores Financeiros</p> <!-- ALTERADO: Descrição para Financeiro -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores Financeiros</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores Financeiros</p> <!-- ALTERADO: Descrição para Financeiro -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento Financeiro da empresa.</p> <!-- ALTERADO: Descrição para Financeiro -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores Financeiros</h3> <!-- ALTERADO: Título da tabela -->
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores Financeiros com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
            ...
            const config = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribuição de Indicadores Financeiros',
                            color: '#f8fafc',
                            font: {
                                size: 16,
                                weight: 'bold'
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_financeiro_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Financeiro - EMBAQUIM</title>
                    <style>
