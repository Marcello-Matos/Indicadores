...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'PCP'
        $where_conditions = ["Departamento = 'PCP'"]; // ALTERADO: 'compras' para 'PCP'
        $query_params = [];
...
<head>
    ...
    <title>P.C.P - EMBAQUIM</title> <!-- ALTERADO: Título para PCP -->
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-industry"></i> <!-- ALTERADO: Ícone para PCP -->
                    </div>
                    <div class="logo-text">
                        <h1>P.C.P - EMBAQUIM</h1> <!-- ALTERADO: Título para PCP -->
                        <p>Sistema de Gestão de Indicadores de PCP</p> <!-- ALTERADO: Descrição para PCP -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores PCP</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores de PCP</p> <!-- ALTERADO: Descrição para PCP -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Planejamento e Controle de Produção da empresa.</p> <!-- ALTERADO: Descrição para PCP -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de PCP</h3> <!-- ALTERADO: Título da tabela -->
                                ...
                                <?php foreach ($dados as $row): ?>
                                    <tr>
                                        ...
                                        <td class="<?php echo ($row['Dt_incl'] === null) ? 'null-cell' : ''; ?>">
                                            <?php 
                                            if ($row['Dt_incl'] instanceof DateTime) {                                             echo $row['Dt_incl']->format('d/m/Y H:i:s');
                                            } else {
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de PCP com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function criarGraficoIndicadores(tipo = 'pie') {
            ...
            const config = {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: tipo === 'pie' ? '#1e293b' : cores,
                        borderWidth: 2,
                        borderRadius: tipo.includes('bar') ? 8 : 0,
                        borderSkipped: false,
                    }]
                },
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Distribuição de Indicadores PCP',
                            color: '#f8fafc',
                            font: {
                                size: 16,
                                weight: 'bold'
            ...
            // Ajustes específicos para gráfico horizontal
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_pcp_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores P.C.P - EMBAQUIM</title>
                    <style>
        ...
        function sortTable(columnIndex) {
            ...
            const isNumeric = columnIndex === 0; // Assumindo que a coluna 0 (Código) é numérica
        ...
        function updateDateTime() {
            ...
            // Adicionar elemento de data/hora se não existir
