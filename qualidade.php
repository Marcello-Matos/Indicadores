...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'Qualidade'
        $where_conditions = ["Departamento = 'Qualidade'"]; // ALTERADO: 'Financeiro' para 'Qualidade'
        $query_params = [];
...
<head>
    ...
    <title>Qualidade - EMBAQUIM</title>
...
<body>
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    ...
                    <div class="logo-text">
                        <h1>Qualidade - EMBAQUIM</h1>
                        <p>Sistema de Gestão de Indicadores de Qualidade</p>
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores de Qualidade</h3>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">📊 Sistema de Indicadores de Qualidade</p>
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Qualidade da empresa.</p>
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de Qualidade</h3>
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de Qualidade com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function criarGraficoIndicadores(tipo = 'pie') {
            ...
            const configBase = {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Distribuição de Indicadores de Qualidade',
                        color: '#f8fafc',
                        font: {
                            size: 16,
                            weight: 'bold',
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_qualidade_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Qualidade - EMBAQUIM</title>
                    <style>
