...
if (empty($erro) && $conn !== false) {
    try {
        // CONSTRUÇÃO DA CONSULTA - ALTERADO PARA 'Manutencao Indl'
        $where_conditions = ["Departamento = 'Manutencao Indl'"]; // ALTERADO: 'Vendas' para 'Manutencao Indl'
        $query_params = [];
...
<head>
    ...
    <title>Manutenção Industrial - EMBAQUIM</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <div class="header-content">
                <div class="logo">
                    <div class="logo-icon">
                        <i class="fas fa-tools"></i> <!-- ALTERADO: Ícone para Manutenção -->
                    </div>
                    <div class="logo-text">
                        <h1>Manutenção Industrial - EMBAQUIM</h1> <!-- ALTERADO: Título para Manutenção -->
                        <p>Sistema de Gestão de Indicadores de Manutenção Industrial</p> <!-- ALTERADO: Descrição para Manutenção -->
                    </div>
                </div>
        ...
        <?php if ($conn && empty($erro)): ?>
            ...
            <div class="dashboard">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h3>Distribuição de Indicadores de Manutenção</h3> <!-- ALTERADO: Título do gráfico -->
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="chart-wrapper">
                        <div style="padding: 30px; color: var(--text-muted); line-height: 1.8;">
                            <p style="color: var(--text-light); font-weight: 600; margin-bottom: 15px;">🔧 Sistema de Indicadores de Manutenção Industrial</p> <!-- ALTERADO: Descrição para Manutenção -->
                            <p style="margin-bottom: 20px; font-weight: 500;">Este dashboard monitora os principais indicadores de desempenho do departamento de Manutenção Industrial da empresa.</p> <!-- ALTERADO: Descrição para Manutenção -->
            ...
            <div class="tabela-container">
                <div class="tabela-header">
                    <h3><i class="fas fa-table"></i> Detalhes dos Indicadores de Manutenção</h3> <!-- ALTERADO: Título da tabela -->
                ...
                <?php else: ?>
                    <div class="no-results">
                        ...
                        <p>Não foram encontrados registros de indicadores de Manutenção Industrial com os filtros aplicados.</p>
                    </div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            a.href = url;
            a.download = 'indicadores_manutencao_' + new Date().toISOString().split('T')[0] + '.xls';
        ...
        function printReport() {
            ...
            document.body.innerHTML = `
                ...
                <html>
                <head>
                    <title>Relatório de Indicadores Manutenção - EMBAQUIM</title>
                    <style>
